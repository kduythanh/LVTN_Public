...
import 'package:lvtn_app/api/hocsinh_api.dart';
...
class HocSinhDetail extends StatefulWidget {
  const HocSinhDetail({super.key});

  @override
  State<HocSinhDetail> createState() => _HocSinhDetailState();
}

class _HocSinhDetailState extends State<HocSinhDetail> {
  bool isLoading = true;
  ...
  Future<void> fetchHocSinhDetail() async {
    try {
      ...
      final res = await HocSinhApi.getHocSinhDetail(maHS: user['soDinhDanh']);
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: AnhHocSinh(maHS: user['soDinhDanh']),
                    ),
                  ],
                ),
