...
import { useAuth, useImageUpload, useTrangThaiCapNhatHoSo } from "@/hooks";
...
export function FormDetail() {
  ...
  const [DTKKChuyen, setDTKKChuyen] = useState("0");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await thcsApi.addHocSinh(user.soDinhDanh, formData);
      setSubmitting(false);
      setSuccess(true);
