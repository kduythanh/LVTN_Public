      ...
      <table className="table">
        <tbody>
          ...
          <tr className="align-items-stretch">
            ...
            <td>
              {hocSinh.thongTinHS.tenTHCSNgoaiTPCT} (
              {hocSinh.thongTinHS.tenXaNgoaiTPCT},{" "}
              {hocSinh.thongTinHS.tenTinhNgoaiTPCT}) (
...
export default function THPTHocSinhDetail() {
  const { user } = useAuth();
