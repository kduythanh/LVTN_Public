...
export default function ImportInitHocSinhTHCS({ onImportSuccess }) {
  const { user } = useAuth();
  ...
  const handleImport = async () => {
    ...
    setUploadProgress(0);
    try {
      const res = await thcsApi.importInitHocSinh(
        user.soDinhDanh,
        excelFile,
        (event) => {
          if (event.total) {
        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header justify-content-center">
              <h5 className="modal-title">Import hồ sơ khởi tạo học sinh</h5>
            </div>
            ...
            <div className="modal-body">
              {loading ? (
                ...
                <div className="alert alert-danger text-center mt-2 mx-auto">
                  Bạn không được phép khởi tạo hồ sơ học sinh do đã hết hạn đăng
                  ký hoặc hệ thống không cho phép!
                </div>
              ) : (
                <>
                  ...
                  <a
                    href="/templates/ImportInitHocSinh_Template.xlsx"
                        ...
                        <span>
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              a.href = url;
                              a.download = "ImportInitHocSinhErrors.txt";
