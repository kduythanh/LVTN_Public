...
export default function ExportTKHocSinhTHCS({ soDinhDanh }) {
  ...
  useEffect(() => {
    const handleExport = async () => {
      ...
      const result = await downloadFile(
        (config) => thcsApi.exportTKHocSinh(soDinhDanh, config),
        `DanhSachTKHocSinh_${soDinhDanh}.xlsx`,
        null,
  ...
  return (
    <>
      <button
        ...
        disabled={loading}
      >
        Xuất danh sách tài khoản học sinh
      </button>
