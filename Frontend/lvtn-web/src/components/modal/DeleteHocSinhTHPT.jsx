...
import { useHocSinhTHPT, useTrangThaiCapNhatHoSo } from "@/hooks";
import { DeleteSpinner, Spinner } from "@/components/common";

export default function DeleteHocSinhTHPT({ selectedHS, onClose }) {
  const modalRef = useRef(null);
  const bsModalRef = useRef(null);

  const { soDinhDanh, fetchHocSinh } = useHocSinhTHPT();
  ...
  const handleDelete = async () => {
    ...
    try {
      await thptApi.deleteHocSinhNgoaiTinh(
        soDinhDanh,
